...
const LoginInput = ({type, value, setValue, placeholder="Email"}: {type?: string, value: string, setValue: any, placeholder?: string}) => {
    const iconSize = 24
    ...
    return (
        <View style={styles.inputWrapper}>
            <MaterialIcons name={type === 'location' ? 'location-pin': 'person-outline'} size={iconSize} color={iconColor} style={{paddingLeft: 14, paddingRight: 6}}/>
            <TextInput onChangeText={setValue} value={value} placeholder={placeholder} placeholderTextColor={'#FFFFFF'} style={styles.inputField} />
        </View>
     );
}
